...
(
  --OID CHAR(32) PRIMARY KEY NOT NULL,
  USERS VARCHAR2(50) NOT NULL, --U_003;D_01001;G_10001;
  ROLE CHAR(32) NOT NULL
-- CONSTRAINT FK_USERS_ROLE_ROLE FOREIGN KEY (ROLE) REFERENCES MYDMS_ROLE (OID)
);
-- COMMENT ON COLUMN MYDMS_USERS_ROLE.OID IS 'OID';
